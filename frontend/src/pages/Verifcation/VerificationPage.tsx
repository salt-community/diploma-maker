                ...
                <div className='verificationinfo-container'>
                    ...
                    <div className='verificationinfo__footer-wrapper'>
                        ...
                        <div className='verificationinfo__footer-wrapper--icon-container'>
                            <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.709 31.709"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> 
