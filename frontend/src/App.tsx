...
import { BootcampRequest, BootcampResponse, StudentUpdateRequestDto, EmailSendRequest, TemplateRequest, TemplateResponse, FormDataUpdateRequest, TrackResponse, MakeActiveSnapshotRequestDto, StudentResponse, Student, UserFontRequestDto } from "./util/types";
...
export default function App() {
  ...
  const postUserFonts = async (userFontsRequestsDto: UserFontRequestDto[]) => {
    console.log(userFontsRequestsDto);
  }
