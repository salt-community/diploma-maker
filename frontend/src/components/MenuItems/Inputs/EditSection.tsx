...
export const EditSection = ({ positionX, setPositionX, positionY, setPositionY, sizeWidth, setSizeWidth, sizeHeight, setSizeHeight, disabled = false}: Props) => {
      ...
      <div className="editlayout__container">
        ...
        <div className="editlayout__menusection">
          ...
          <div className={"editlayout__menusection--inputwrapper btnmenu " + (!positionX && !positionY && !sizeWidth && !sizeHeight && 'disabled')}>
            <button className={'editlayout__menusection--btn '}>
