      ...
      <div className={`popup_confirmation 
        ...
        <div className="popup_confirmation-content">
          {infoPopupType === InfoPopupType.form ?
            <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#197eff"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><g> 
