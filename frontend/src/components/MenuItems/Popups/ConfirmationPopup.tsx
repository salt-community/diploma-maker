...
export const ConfirmationPopup = ({ show, popupType, title, text, confirmClick, abortClick }: Props) => {
  ...
  return (
    <div className={`popup ${popupType === PopupType.question ? 'question' : 'success'} ${visible ? 'fade-in' : 'fade-out'}`}>
      <div className="popup-content">
        ...
        <div className='popup-content-text'>
          <h1>{title}</h1>
          <p>{text}</p>
          <div className='popup-content-btn-container'>
            <button onClick={confirmClick} className='popup-content-btn'>
            ...
            <button onClick={abortClick} className='popup-content-btn'>
