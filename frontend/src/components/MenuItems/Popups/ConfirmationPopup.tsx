  ...
  return (
    <div className={`popup_confirmation ${confirmationPopupType === ConfirmationPopupType.question ? 'question' : 'success'} ${show ? 'fade-in' : 'fade-out'}`}>
      <div className="popup_confirmation-content">
        ...
        :
          <svg fill="#197eff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" enable-background="new 0 0 512 512"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> 
