export const ReadmeIcon = () => {
  return (
    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#000000">
        ...
        <polygon className="fill" fill="#ababba" points="481.767,313.228 257.908,430.587 261.298,437.071 485.157,319.697 "></polygon>
        <polygon className="fill" fill="#ababba" points="254.908,469.806 486.048,348.603 482.657,342.119 251.501,463.337 "></polygon>
        <path className="fill" fill="#ababba" d="M486.173,364.541L239.205,493.962c-7.5,1.906-5.781-3.953-5.797-13.125 c0.703-24.656,6.719-46.203,13.406-53.25L33.017,142.525c-9.547,11.453-17.766,47.094-10.969,85.891l211.141,281.515 c1.531,2.031,4.328,2.656,6.563,1.469l247.875-131.312c2.203-1.172,3.719-3.328,4.078-5.797c0.328-2.469-0.516-4.953-2.328-6.688 L486.173,364.541z"></path>
        </g>
    </svg>
  );
};