export const HomeIcon = () => {
    return (
        <svg width="24px" height="24px" viewBox="0 -0.5 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" className="si-glyph si-glyph-house">
            ...
            <g stroke="none" strokeWidth="1" className="fill" fill="#ababba" fillRule="evenodd">
