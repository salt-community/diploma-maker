...
export const createUpdatedTemplate = (currentTemplate: any, designer: any) => {
    ...
    const updatedTemplate = {
      ...
      introStyling: {
        ...
        FontName: currentTemplateFields.schemas[0].header.fontmain,
      ...
      mainStyling: {
        ...
        FontName: currentTemplateFields.schemas[0].main.fontmain,
      ...
      footerStyling: {
        ...
        FontName: currentTemplateFields.schemas[0].footer.fontmain,
